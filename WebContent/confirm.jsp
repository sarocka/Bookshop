...
<title>Bookshop|Confirm payment</title>
<style>
ul {
...
/* div.background {
  background: url(motiv.jpg) repeat;
...
Book's title: <%=book.getTitle()%><br>
Price: <%=book.getPrice()*count %><br>
<form action='ProcessingPayment'>
<input type='hidden' name='countConfirm' value='<%=count%>'/>
<input class="addToWishList" type='submit' value='Confirm'/><a class="cancel" href='index.html'>Cancel</a>
</form>
